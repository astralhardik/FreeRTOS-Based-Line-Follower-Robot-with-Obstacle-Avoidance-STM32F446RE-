...
#define IR_LEFT_MOST_Pin GPIO_PIN_0
#define IR_LEFT_MOST_GPIO_Port GPIOC
#define IR_LEFT_Pin GPIO_PIN_1
#define IR_LEFT_GPIO_Port GPIOC
#define IR_CENTER_Pin GPIO_PIN_2
#define IR_CENTER_GPIO_Port GPIOC
...
#define IR_RIGHT_MOST_Pin GPIO_PIN_4
#define IR_RIGHT_MOST_GPIO_Port GPIOC
...
#define Echo_pin_Pin GPIO_PIN_7
